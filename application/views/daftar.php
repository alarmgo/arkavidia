...
<head>
	...
	<title>Daftar KoncoTernak</title>
			...
			<div class="row w-100 h-100">
				...
				<div class="col m-auto">
					<div class="text-center" style="font-size: 1.5rem;">
						Daftar <b>Konco<font color="#8B0C0C">Ternak</font></b>
					</div>
					...
					<div class="btn btn-input shadow text-left mt-3 w-100" style="height: 4rem;">
						<font size="2rem">Nama</font> <br>
						<input type="text" name="nama" placeholder="Masukkan Nama" style="height: 1rem; width: 100%; border: 0; outline: 0; border-bottom: 1px solid gray">
                    </div>
                    <div class="btn btn-input shadow text-left mt-1 w-100" style="height: 4rem;">
						<font size="2rem">Username</font> <br>
						<input type="text" name="username" placeholder="Masukkan Username" style="height: 1rem; width: 100%; border: 0; outline: 0; border-bottom: 1px solid gray">
                    </div>
                    <div class="btn btn-input shadow text-left mt-1 w-100" style="height: 4rem;">
						<font size="2rem">Email</font> <br>
						<input type="email" name="email" placeholder="Masukkan Email" style="height: 1rem; width: 100%; border: 0; outline: 0; border-bottom: 1px solid gray">
					</div>
					<div class="btn btn-input shadow text-left mt-1 w-100" style="height: 4rem;">
					...
					<div class="text-right">
						<a href="homepage" class="btn btn-outline-dark mt-3">Daftar</a>
					</div>
				</div>
			</div>
		</div>
