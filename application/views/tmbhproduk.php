	...
	<div class="container-fluid px-0" style="height:100vh;">
		...
		<div class="col-8 shadow-sm" style="border:1px solid #999999;  height: 37vh; width: 130vw; position: relative; top: 2%; left: 17%;">
			...
			<div class="col text-center mt-3">
				...
				<div class="row">
					<div class="col text-center mt-3">
						<button type="button" style="font-size:0.8em;">+ Pilih Gambar Produk</button>
					</div>
				</div>
				<div class="row">
					<div class="col">
		...
		<div class="col-8 shadow-sm mt-3" style="border:1px solid #999999;  height: 85vh; width: 130vw; position: relative; top: 2%; left: 17%;">
			<div class="row">
				<div class="col text-left mt-3">
					Informasi Produk
					<hr>
			...
			<div class="row">
				<div class="col-4"> </div>
				<div class="col-8">
					<a href="berhasiltmbh" class="btn btn-outline-dark text-center mb-3" style="width: 39rem; position: relative; right: 4rem;">Simpan & Tambah Baru</a>
				</div>
			</div>
			<div class="row h-25">
				<div class="col-4"> </div>
